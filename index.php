    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-8">
          ...
          <p class="fs-6">Your website is more than just an online presence — it's a vital tool for branding, customer engagement, and business growth. Our website design, branding, and maintenance services ensure your site is visually compelling, secure, and optimized for performance.
          </p>
        </div>
        <div class="col-sm-4">
        ...
        <div class="col-sm-12 fw-bold text-center pt-5">
          <p class="fs-3">We specialize in SEO-driven, accessible web sites designed for small businesses, entrepreneurs, and freelancers.
          </p>
        </div>
      </div>
    </div>
