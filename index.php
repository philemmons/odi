...
<body id="toTop">
    ...
    <div class="py-6 px-5 text-center bg-img-hero">
      <div class="container-fluid py-5">
        <section aria-label="Hero banner">
          ...
          <p class="col-lg-8 mx-auto fs-4 py-2 text-white">Whether you need a one-time update, or ongoing support, we help your website to stay competitive and effective.
          </p>
        </section>
      </div>
    </div>
  ...
  <main>
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-8">
          ...
          <p class="fs-5">Your website is more than just an online presence — it's a vital tool for branding, customer engagement, and business growth. Our website design, branding, and maintenance services ensure your site is visually compelling, secure, and optimized for performance.
          </p>
        </div>
        <div class="col-sm-4">
    ...
    <div class="container py-5">
      <div class="row">
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Custom Website Design & Branding
          </p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Content Updates & Support</p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Website Maintenance & Security
          </p>
          <ul>
            <li>Enhances credibility and strengthens customer trust in your brand.</li>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">WCAG 2.1 Compliance & Accessibility</p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">E-Commerce Solutions</p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Plugin & Software Updates</p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">SEO & Performance Optimization</p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Hosting, Domain, and DNS Support</p>
          <ul>
  ...
  <article>
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Brand-Focused Design & Strategy
          </p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">SEO-Optimized & Accessible Websites</p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Flexible Support Options</p>
          <ul>
            <li>Choose between one-time fixes or long-term maintenance plans tailored to your business needs.</li>
          </ul>
        </div>
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Fast Turnaround Time</p>
          <ul>
        ...
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Dedicated Ongoing Support Option</p>
          <ul>
            <li>We provide continuous assistance and improvements, keeping your website modern and competitive.</li>
          </ul>
        </div>
        <div class="col-sm-6">
          <p class="fw-bold fs-4 p-0">Competitive Services</p>
          <ul>
